...
%%
function [iNO_end, iEL_end] = PP_model_UpperOuter(fileID, iNO, iEL, Upper_arc_num, Upper_angle, Upper_angle_origin, Upper_CoC, Upper_R, Upper_Ep, Stadium_R, Stadium_arc_num, Stadium_angle, FZ)
%% NODE
